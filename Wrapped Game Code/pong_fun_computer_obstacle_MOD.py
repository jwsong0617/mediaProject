...
obs = pygame.Surface((180, 10))
obs1 = obs.convert()
obs1.fill((220,220,220))
obs2 = obs.convert()
obs2.fill((220,220,220))
obs3 = obs.convert()
obs3.fill((220,220,220))
obs4 = obs.convert()
obs4.fill((220,220,220))
...
class GameState:
    def __init__(self):
        ...
        self.obs1_x, self.obs2_x, self.obs3_x, self.obs4_x = 230. , 230., 230., 230.
...
#                    self.bar2_y += 0.
        ...
        if self.circle_x >= self.obs1_x and self.circle_x <= self.obs1_x + 180.:
            if self.circle_y <= self.obs1_y:
                self.speed_y = +self.speed_y
            elif self.circle_y >= self.obs1_y + 10.:
                self.speed_y = -self.speed_y
            elif self.circle_y <= self.obs2_y:
                self.speed_y = +self.speed_y
            elif self.circle_y >= self.obs2_y + 10.:
                self.speed_y = -self.speed_y
            elif self.circle_y <= self.obs3_y:
                self.speed_y = +self.speed_y
            elif self.circle_y >= self.obs3_y + 10.:
                self.speed_y = -self.speed_y
            elif self.circle_y <= self.obs4_y:
                self.speed_y = +self.speed_y
